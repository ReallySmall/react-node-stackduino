...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement('input', { type: 'text', name: this.props.name, value: this.state.value, placeholder: this.props.format, onChange: this.handleChange, onBlur: this.handleBlur, autoComplete: 'off', className: 'form-control' });
	}
...
module.exports = {
	...
	renderItem: function renderItem(i) {
		...
		return React.createElement(
			'div',
			{ key: i.key, className: 'field-item' },
			React.createElement(
				'a',
				{ href: 'javascript:;', className: 'field-item-button btn-cancel', onClick: this.removeItem.bind(this, i) },
				'×'
			),
			React.createElement('input', { ref: 'input_' + i.key, className: 'form-control multi', type: 'text', name: this.props.path, value: i.value, onChange: this.updateItem.bind(this, i), autoComplete: 'off' })
		);
		/* eslint-enable */
	},
...
module.exports = {
	...
	renderItem: function renderItem(i) {
		...
		return React.createElement(
			...
			React.createElement('input', { ref: 'input_' + i.key, className: 'form-control multi datepicker_' + i.key, type: 'text', name: this.props.path, value: i.value, onChange: this.updateItem.bind(this, i), autoComplete: 'off' })
		);
		/* eslint-enable */
	},
...
var Mixins = module.exports.Mixins = {
	...
	Collapse: {
		...
		renderCollapse: function renderCollapse() {
			...
			return React.createElement(
				'div',
				{ className: 'field field-type-' + this.props.type },
				React.createElement(
					'div',
					{ className: 'col-sm-12' },
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: 'javascript:;', onClick: this.uncollapse },
							'+ Add ',
	...
	renderUI: function renderUI() {
		...
		if (this.shouldRenderField()) {
			input = React.createElement(
				...
				React.createElement(
					'label',
					{ htmlFor: this.props.path, className: 'checkbox' },
			...
			input = React.createElement(
				'div',
				{ className: fieldClassName },
				React.createElement('img', { src: imgSrc, width: '16', height: '16', className: state, style: { marginRight: 5 } }),
				React.createElement(
					'span',
					null,
					this.props.label
		...
		return React.createElement(
			'div',
			{ className: 'field field-type-boolean' },
			input
		);
	}
...
module.exports = Field.create({
	...
	renderImagePreview: function renderImagePreview() {
		...
		if (url) {
			body = React.createElement(
				'a',
				{ className: 'img-thumbnail', href: this.getImageURL() },
				body
			);
		} else {
			body = React.createElement(
		...
		return React.createElement(
			'div',
			{ key: this.props.path + '_preview', className: className },
			body
		);
	},
  ...
  */
	renderImageDetails: function renderImageDetails(add) {
		...
		return React.createElement(
			'div',
			{ key: this.props.path + '_details', className: 'image-details' },
			values,
			add
		);
	},
  ...
  */
	renderAlert: function renderAlert() {
		if (this.hasLocal()) {
			return React.createElement(
				'div',
				{ className: 'upload-queued pull-left' },
				React.createElement(
					'div',
			...
			return React.createElement(
				'div',
				{ className: 'select-queued pull-left' },
				React.createElement(
					'div',
					{ className: 'alert alert-success' },
					'Image selected from Cloudinary'
				)
			);
		} else if (this.state.removeExisting) {
			return React.createElement(
				'div',
				{ className: 'delete-queued pull-left' },
				React.createElement(
					'div',
  ...
  */
	renderClearButton: function renderClearButton() {
		if (this.state.removeExisting) {
			return React.createElement(
				'button',
				{ type: 'button', className: 'btn btn-link btn-cancel btn-undo-image', onClick: this.undoRemove },
				'Undo Remove'
			);
		} else {
			var clearText;
			...
			return React.createElement(
				'button',
				{ type: 'button', className: 'btn btn-link btn-cancel btn-delete-image', onClick: this.removeImage },
				clearText
			);
		}
	},
	...
	renderImageToolbar: function renderImageToolbar() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'button',
					{ type: 'button', onClick: this.changeImage, className: 'btn btn-default btn-upload-image' },
	...
	renderUI: function renderUI() {
		...
		return React.createElement(
			'div',
			{ className: 'field field-type-cloudinaryimage' },
			React.createElement(
				'label',
				{ className: 'field-label' },
				this.props.label
...
var Thumbnail = React.createClass({
	...
	render: function render() {
		...
		if (!this.props.isQueued) {
			imageDetails = React.createElement(
				'div',
				{ className: 'image-details' },
				React.createElement(
					'button',
					{ onClick: this.props.toggleDelete, type: 'button', className: 'btn btn-link btn-cancel btn-undo-remove' },
					actionLabel
				)
			);
		}
		...
		return React.createElement(
			'div',
			{ className: 'image-field image-sortable row col-sm-3 col-md-12', title: title },
			React.createElement(
				'div',
				{ className: previewClassName },
				React.createElement(
					'a',
					{ href: this.props.url, className: 'img-thumbnail' },
					React.createElement('img', { style: { height: '90' }, className: 'img-load', src: this.props.url }),
...
module.exports = Field.create({
	...
	renderToolbar: function renderToolbar() {
		...
		var push = function push(queueType, alertType, count, action) {
			...
			body.push(React.createElement(
				'div',
				{ key: queueType + '-toolbar', className: queueType + '-queued' + ' pull-left' },
				React.createElement(
					'div',
		...
		if (this.hasFiles()) {
			clearFilesButton = React.createElement(
				'button',
				{ type: 'button', className: 'btn btn-default btn-upload', onClick: this.clearFiles },
				'Clear selection'
			);
		}
		...
		return React.createElement(
			'div',
			{ className: 'images-toolbar row col-sm-3 col-md-12' },
			React.createElement(
				'div',
				{ className: 'pull-left' },
				React.createElement(
					'button',
					{ type: 'button', className: 'btn btn-default btn-upload', onClick: this.changeImage },
					'Select files'
				),
				clearFilesButton
			),
	...
	renderPlaceholder: function renderPlaceholder() {
		return React.createElement(
			'div',
			{ className: 'image-field image-upload row col-sm-3 col-md-12', onClick: this.changeImage },
			React.createElement(
				'div',
				...
				React.createElement(
					'span',
					{ className: 'img-thumbnail' },
					React.createElement('span', { className: 'img-dropzone' }),
					React.createElement('div', { className: 'ion-picture img-uploading' })
				)
			),
			React.createElement(
				'div',
	...
	renderContainer: function renderContainer() {
		return React.createElement(
			'div',
			{ className: 'images-container clearfix' },
	...
	renderUI: function renderUI() {
		return React.createElement(
			'div',
			{ className: 'field field-type-cloudinaryimages' },
			React.createElement(
				'label',
				{ className: 'field-label' },
				this.props.label
...
module.exports = Field.create({
	...
	isValid: function isValid(value) {
		return _moment(value, this.inputFormat).isValid();
	},

	// TODO: Move format() so we can share with server-side code
	format: function format(dateValue, _format) {
		_format = _format || this.inputFormat;
	...
	setToday: function setToday() {
		this.setDate(_moment().format(this.inputFormat));
	},
	...
	renderUI: function renderUI() {
		...
		if (this.shouldRenderField()) {
			input = React.createElement(
				'div',
				{ className: fieldClassName },
				React.createElement(DateInput, { ref: 'dateInput', name: this.props.path, format: this.inputFormat, value: this.state.value, onChange: this.valueChanged, yearRange: this.props.yearRange }),
				React.createElement(
					'button',
					{ type: 'button', className: 'btn btn-default btn-set-today', onClick: this.setToday },
					'Today'
				)
			);
		} else {
		...
		return React.createElement(
			'div',
			{ className: 'field field-type-date' },
			React.createElement(
				'label',
				{ htmlFor: this.props.path, className: 'field-label' },
				this.props.label
			),
			input,
			React.createElement(
				'div',
				{ className: 'col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2 field-note-wrapper' },
				React.createElement(Note, { note: this.props.note })
			)
		);
	}
...
module.exports = Field.create({
	...
	// TODO: Move isValid() so we can share with server-side code
	isValid: function isValid(value) {
		return _moment(value, this.parseFormats).isValid();
	},
	...
	setNow: function setNow() {
		var dateValue = _moment().format(this.dateInputFormat);
		var timeValue = _moment().format(this.timeInputFormat);
		this.setState({
			dateValue: dateValue,
			timeValue: timeValue
		});
	...
	renderUI: function renderUI() {
		...
		if (this.shouldRenderField()) {
			input = React.createElement(
				...
				React.createElement(
					'button',
					{ type: 'button', className: 'btn btn-default btn-set-now', onClick: this.setNow },
					'Now'
				)
			);
		} else {
		...
		return React.createElement(
			'div',
			{ className: 'field field-type-datetime' },
			React.createElement(
				'label',
				{ className: 'field-label' },
				this.props.label
...
module.exports = Field.create({
	...
	renderValue: function renderValue() {
		return this.props.value ? React.createElement(
			'a',
			{ className: 'ui-related-item', href: 'mailto:' + this.props.value },
			this.props.value
		) : React.createElement(
			'div',
			{ className: 'help-block' },
...
module.exports = Field.create({
	...
	renderValue: function renderValue() {
		...
		var imagePreview = this.props.value.thumbnailUrl ? React.createElement(
			'div',
			{ className: 'image-preview' },
			React.createElement(
				'a',
				{ href: this.props.value.url, className: 'img-thumbnail' },
				React.createElement('img', { width: this.props.value.thumbnailWidth, height: this.props.value.thumbnailHeight, src: this.props.value.thumbnailUrl })
			)
		) : null;
	...
	renderField: function renderField() {
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'col-sm-6' },
				React.createElement('input', { type: 'text', name: this.props.path + '[1]', placeholder: 'Latitude', ref: 'lat', value: this.props.value[1], onChange: this.valueChanged.bind(this, 1), autoComplete: 'off', className: 'form-control' })
			),
			React.createElement(
				'div',
				{ className: 'col-sm-6' },
				React.createElement('input', { type: 'text', name: this.props.path + '[0]', placeholder: 'Longitude', ref: 'lng', value: this.props.value[0], onChange: this.valueChanged.bind(this, 0), autoComplete: 'off', className: 'form-control' })
			)
		);
	}
...
module.exports = Field.create({
	...
	renderEditor: function renderEditor(readOnly) {
		...
		return React.createElement(
			'div',
			{ className: className },
			React.createElement('textarea', { ref: 'editor', style: style, onChange: this.valueChanged, id: this.state.id, className: this.getFieldClassName(), name: this.props.path, readOnly: readOnly, value: this.props.value })
		);
	},
...
module.exports = Field.create({
	...
	renderClearButton: function renderClearButton() {
		if (this.state.removeExisting) {
			return React.createElement(
				'button',
				{ type: 'button', className: 'btn btn-link btn-cancel btn-undo-file', onClick: this.undoRemove },
				'Undo Remove'
			);
		} else {
			var clearText;
			...
			return React.createElement(
				'button',
				{ type: 'button', className: 'btn btn-link btn-cancel btn-delete-file', onClick: this.removeFile },
				clearText
			);
		}
	},
	...
	renderFileToolbar: function renderFileToolbar() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'button',
					{ type: 'button', onClick: this.changeFile, className: 'btn btn-default btn-upload-file' },
	...
	renderUI: function renderUI() {
		...
		return React.createElement(
			'div',
			{ className: 'field field-type-localfile' },
			React.createElement(
				'label',
				{ className: 'field-label' },
				this.props.label
...
var Item = React.createClass({
	...
	render: function render() {
		...
		if (this.props.deleted) {
			body.push(React.createElement(
				'span',
				{ className: 'file-note-delete' },
				'save to delete'
			));
		} else if (this.props.isQueued) {
			body.push(React.createElement(
				'span',
				{ className: 'file-note-upload' },
				'save to upload'
			));
		}
		...
		if (!this.props.isQueued) {
			...
			body.push(React.createElement(
				'span',
				{ className: 'file-action', onClick: this.props.toggleDelete },
				actionLabel
			));
		}
		...
		return React.createElement(
			'div',
			{ className: itemClassName, key: this.props.key },
			body
		);
	}
...
module.exports = Field.create({
	...
	renderToolbar: function renderToolbar() {
		...
		return React.createElement(
			'div',
			{ className: 'files-toolbar row col-sm-3 col-md-12' },
			React.createElement(
				'div',
				{ className: 'pull-left' },
				React.createElement(
					'button',
					{ type: 'button', className: 'btn btn-default btn-upload', onClick: this.changeFiles },
					'Upload'
				),
				clearFilesButton
			)
	...
	renderPlaceholder: function renderPlaceholder() {
		return React.createElement(
			'div',
			{ className: 'file-field file-upload row col-sm-3 col-md-12', onClick: this.changeFiles },
			React.createElement(
				'div',
	...
	renderUI: function renderUI() {
		return React.createElement(
			'div',
			{ className: 'field field-type-files' },
			React.createElement(
				'label',
				{ className: 'field-label' },
				this.props.label
...
module.exports = Field.create({
	...
	renderField: function renderField(path, label, collapse) {
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'col-sm-2 location-field-label' },
				React.createElement(
					'label',
			...
			React.createElement(
				'div',
				{ className: 'col-sm-10 col-md-7 col-lg-6 location-field-controls' },
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-xs-6' },
						React.createElement('input', { type: 'text', name: this.props.path + '.postcode', ref: 'postcode', value: this.props.value.postcode, onChange: this.fieldChanged.bind(this, 'postcode'), className: 'form-control', placeholder: 'Postcode' })
					)
				)
			)
		);
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-xs-6' },
						React.createElement('input', { type: 'text', name: this.props.paths.geo + '[1]', ref: 'geo1', value: this.props.value.geo ? this.props.value.geo[1] : '', onChange: this.geoChanged.bind(this, 1), placeholder: 'Latitude', className: 'form-control' })
					),
					React.createElement(
						'div',
						{ className: 'col-xs-6' },
						React.createElement('input', { type: 'text', name: this.props.paths.geo + '[0]', ref: 'geo0', value: this.props.value.geo ? this.props.value.geo[0] : '', onChange: this.geoChanged.bind(this, 0), placeholder: 'Longitude', className: 'form-control' })
					)
				)
			)
		);
	...
	renderGoogleOptions: function renderGoogleOptions() {
		...
		var replace = this.state.improve ? React.createElement(
			'label',
			{ className: 'checkbox overwrite', htmlFor: this.props.paths.overwrite },
			React.createElement('input', { type: 'checkbox', name: this.props.paths.overwrite, id: this.props.paths.overwrite, value: 'true', onChange: this.updateGoogleOption.bind(this, 'overwrite'), checked: this.state.overwrite }),
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2 improve-options' },
				React.createElement(
					'label',
					{ className: 'checkbox autoimprove', htmlFor: this.props.paths.improve, title: 'When checked, this will attempt to fill missing fields. It will also get the lat/long' },
					React.createElement('input', { type: 'checkbox', name: this.props.paths.improve, id: this.props.paths.improve, value: 'true', onChange: this.updateGoogleOption.bind(this, 'improve'), checked: this.state.improve }),
	...
	renderUI: function renderUI() {
		...
		if (!this.shouldRenderField()) {
			return React.createElement(
				'div',
				{ className: 'field field-type-location' },
				React.createElement(
					'label',
					{ className: 'field-label' },
					this.props.label
		...
		/* eslint-disable no-script-url */
		var showMore = !_.isEmpty(this.state.collapsedFields) ? React.createElement(
			'a',
			{ href: 'javascript:;', className: 'field-label-companion', onClick: this.uncollapseFields },
			'(show more fields)'
		) : null;
		/* eslint-enable */
...
module.exports = Field.create({
	...
	renderField: function renderField() {
		...
		return React.createElement(
			'div',
			{ className: 'md-editor' },
			React.createElement('textarea', { name: this.props.paths.md, style: styles, defaultValue: this.props.value.md, ref: 'markdownTextarea', className: 'form-control markdown code' })
		);
	}
});
...
module.exports = Field.create({
	...
	renderValue: function renderValue() {
		...
		if (this.props.value.first) {
			values.first = React.createElement(
				'div',
				{ className: 'field-value' },
		...
		if (this.props.value.last) {
			values.last = React.createElement(
				'div',
				{ className: 'field-value' },
...
module.exports = Field.create({
	...
	renderValue: function renderValue() {
		return React.createElement(
			'div',
			{ className: 'field-value' },
			this.props.value ? 'password set' : 'password not set'
		);
	},
	...
	renderChangeButton: function renderChangeButton() {
		...
		return React.createElement(
			'button',
			{ type: 'button', className: 'btn btn-default', onClick: this.showChangeUI },
			label
		);
	}
...
module.exports = Field.create({
	...
	renderValue: function renderValue() {
		...
		if (this.state.expandedValues && this.state.expandedValues.length) {
			...
			_.each(this.state.expandedValues, function (item) {
				body.push(React.createElement(
					'a',
					{ href: '/keystone/' + this.props.refList.path + '/' + item.value, className: 'related-item-link' },
					item.label
				));
			}, this);
	...
	renderField: function renderField() {
		...
		if (!this.props.many && this.props.value) {
			body.push(React.createElement(
				'a',
				{ href: '/keystone/' + this.props.refList.path + '/' + this.props.value, className: 'btn btn-link btn-goto-linked-item' },
				'view ',
				this.props.refList.singular.toLowerCase()
			));
		}
